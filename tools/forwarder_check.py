...
SIMPLE_ANSWER = dns.message.from_text("""id 24452
opcode QUERY
rcode NOERROR
flags QR RD RA
;QUESTION
...
RRSIG_ANSWER = dns.message.from_text("""id 54122
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
DNSKEY_ANSWER = dns.message.from_text("""id 54217
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
DS_QUERY = answer_checker.make_query("test.knot-resolver.cz", "DS", want_dnssec=True)
DS_ANSWER = dns.message.from_text("""id 8704
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
;ANSWER
test.knot-resolver.cz.	1800	IN	DS	29017 8 2 482653368CA59CD628D26E169FDF0EB8278A438264D1F50DA85324D3 0676869F
...
NSEC_NEGATIVE_ANSWER = dns.message.from_text("""id 18831
opcode QUERY
rcode NXDOMAIN
flags QR RD RA AD
edns 0
...
NSEC3_NEGATIVE_ANSWER = dns.message.from_text("""id 13396
opcode QUERY
rcode NXDOMAIN
flags QR RD RA AD
edns 0
...
UNKNOWN_TYPE_ANSWER = dns.message.from_text(r"""id 51471
opcode QUERY
rcode NOERROR
flags QR RD RA
;QUESTION
...
NONEXISTENT_DS_DELEGATION_NSEC_ANSWER = dns.message.from_text("""id 62512
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
NONEXISTENT_DS_DELEGATION_NSEC3_ANSWER = dns.message.from_text("""id 19144
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
NONEXISTENT_DELEGATION_FROM_NSEC_ANSWER = dns.message.from_text("""id 4179
opcode QUERY
rcode NXDOMAIN
flags QR RD RA AD
edns 0
...
NONEXISTENT_DELEGATION_FROM_NSEC3_ANSWER = dns.message.from_text("""id 63997
opcode QUERY
rcode NXDOMAIN
flags QR RD RA AD
edns 0
...
NONEXISTENT_TYPE_NSEC3_ANSWER = dns.message.from_text("""id 31235
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
...
NONEXISTENT_TYPE_NSEC_ANSWER = dns.message.from_text("""id 32231
opcode QUERY
rcode NOERROR
flags QR RD RA AD
edns 0
